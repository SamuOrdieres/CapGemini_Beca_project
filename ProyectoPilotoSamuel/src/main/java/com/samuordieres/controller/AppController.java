...
//		model.addAttribute("centroTuristico", centroTuristico);
	...
	public String saveCentroTuristico(@Valid CentroTuristico centroTuristico, BindingResult result, ModelMap model) {
		...
		model.addAttribute("success", "El Centro Tur�stico: " + centroTuristico.getNombre() + ", se ha REGISTRADO SATISFACTORIAMENTE");
		return "success";
	}
	...
	public String updateCentroTuristico(@Valid CentroTuristico centroTuristico, BindingResult result, ModelMap model,
		...
		model.addAttribute("success", "El Centro Tur�stico: " + centroTuristico.getNombre() + ", se ha ACTUALIZADO SATISFACTORIAMENTE");
		return "success";
	}
	...
	//  --- A PARTIR DE AQU� EMPIEZAN LOS METODOS DE RESERVA ---
