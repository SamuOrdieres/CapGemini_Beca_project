...
INSERT INTO `centros_turisticos` VALUES (1,'Hotel Rural El Cuartamenteru',10),(2,'Hotel Pugide',24),(3,'Hotel El Texeu',16),(4,'Hotel Porrua',8),(5,'Hotel Puerta del Oriente',17);
...
INSERT INTO `clientes` VALUES (1,'Samuel','Ordieres','Rodríguez','11222333A'),(2,'Alberto','Cuervo','Cuervo','22333445H'),(3,'Lucia','Garcia','Garcia','33444555C'),(22,'Lola','Rodriguez','Calleja','10810999k'),(23,'Sandra','Alvarez','Fernandez','23991944A'),(24,'ASDFJOa','ASDFJO','ASDJO','ASDF333444');
...
CREATE TABLE `emails` (
  ...
  CONSTRAINT `fk_emails_clientes1` FOREIGN KEY (`clientes_id`) REFERENCES `clientes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `emails` VALUES (1,'samuordieres@gmail.com',1),(2,'acc@gmail.com',2),(3,'luciagarcia@gmail.com',3),(5,'lola@lola.com',22),(6,'saf@saf.saf',23),(7,'asdf@asdf.com',24);
...
CREATE TABLE `reservas` (
  ...
  CONSTRAINT `fk_centros_turisticos_has_clientes_centros_turisticos1` FOREIGN KEY (`centros_turisticos_id`) REFERENCES `centros_turisticos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_centros_turisticos_has_clientes_clientes1` FOREIGN KEY (`clientes_id`) REFERENCES `clientes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `reservas` VALUES (1,2,1,'2018-06-22','2018-06-24');
...
-- Dump completed on 2018-12-11 13:52:36
